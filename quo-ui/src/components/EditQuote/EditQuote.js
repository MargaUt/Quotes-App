        ...
        <div className="card-body">
         <form onSubmit={this.handleSubmit}>
            <div className="form-group">
              ...
              <div className="form-group">
                <label for="inlineFormInputDate">  Date ({this.state.date}):</label>
                <input type="text"
                    value={this.state.date}
                    onChange={this.handleDate} className="form-control" id="inlineFormInputName" placeholder={this.state.currentDate}/>
              </div>

                <div className="form-group">
                <label  for="inlineFormInputName"> Quote page ({this.state.page}):</label>
                <input type="number"
                    value={this.state.page}
                    onChange={this.handlePage} className="form-control" id="inlineFormInputName" placeholder={this.state.page}/>
              </div>

              <div className="form-group">
                <label  for="inlineFormInputText">Quote ({this.state.text}):</label>
                <input type="text" className="form-control" id="inlineFormInputText" value={this.state.text}
                    onChange={this.handleText} placeholder={this.state.text}/>
              </div>


                <div className="form-check">
                  <input className="form-check-input" type="checkbox" checked={this.state.favourite}
                    onChange={this.handleQuoteFavourite} id="autoSizingCheck3"/>
                  <label className="form-check-label" for="autoSizingCheck3"> Quote is
