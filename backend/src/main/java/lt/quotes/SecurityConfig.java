...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
	...
	//TODO write technical comment
	protected void configure(HttpSecurity http) throws Exception { 
		http.cors().and().authorizeRequests().antMatchers(HttpMethod.GET, "/api/book").permitAll()
				.antMatchers(HttpMethod.GET, "/api/book/*/*").permitAll().antMatchers(HttpMethod.GET, "/api/quote/*")
				.permitAll().antMatchers("/", "/swagger-ui/", "/api/user/loggedUsername").permitAll()
