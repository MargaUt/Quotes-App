...
class QuoteButtons extends Component {
  ...
  handleEditQuote = (e, date) => this.props.history.push(`/edit_quote/${date}`);
      ...
      <div className="card-body">
        {this.state.loggedUserName !== null && (
          <button
            ...
            onClick={(e) => this.handleEditQuote(e, this.state.date)}
          >
            Edit Quote
          </button>
        )}
        {this.state.loggedUserName !== null && (
          <button
            ...
            data-toggle="modal"
            data-target={
              "#modal-" + this.clean(this.state.date) + "-" + this.state.page
            }
          >
            Delete
          </button>
        ...
        {this.state.loggedUserName !== null && (
          ...
          >
            Do you want to delete quote{" "}
            {moment(this.state.date).format("YYYY-MM-DD")} date ?
          </DeleteQuoteModal>
        )}
      </div>
    );
